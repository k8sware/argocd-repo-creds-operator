...
import (
	...
	"github.com/k8sware/argocd-repo-creds-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f311d304.repocreds.io",
	...
	if err = (&controller.ArgoCDRepoCredReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ArgoCDRepoCred")
		os.Exit(1)
	}
